...
INSERT INTO myServer.account(id, name, parent_id, type, balance) VALUES (UUID(), "Charging",(SELECT id from myServer.parent_category pc where pc.name = "Transportation"), "Paper", 0.0);
