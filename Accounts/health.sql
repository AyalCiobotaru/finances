...
INSERT INTO myServer.account(id, name, parent_id, type, balance) VALUES (UUID(), "Health", (SELECT id from myServer.parent_category pc where pc.name = "Health"), "Paper", 0.0);
