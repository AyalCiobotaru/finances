...
INSERT INTO myServer.account(id, name, parent_id, type, balance) VALUES (UUID(), "Delivery/ Carry-Out", (SELECT id from myServer.parent_category pc where pc.name = "Daily Living"), "Paper", 0.0);
