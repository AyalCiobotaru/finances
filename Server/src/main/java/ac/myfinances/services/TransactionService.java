...
public class TransactionService {
     ...
     */
//    public Flux<Transaction> updateOrAddLogic(List<TransactionDTO> transactions) {
...
//            });
//            Flux<Transaction> savedTransactions = this.transactionRepository.saveAll(newTransactions);
//        }
//
